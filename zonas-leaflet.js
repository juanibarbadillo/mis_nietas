...
export function configurarZonasCircleAdmin(container) {
    ...
    function ensureMap() {
        ...
        try {
            leafletMap = L.map(mapEl).setView([-34.7493, -68.0575], 13);
            ...
            marker = L.marker([-34.7493, -68.0575]);
            ...
            ensureMap()
                .then(function () {
                    ...
                    if (isFinite(lat) && isFinite(lng)) {
                        ...
                        leafletMap.setView([-34.7493, -68.0575], 13);
                        marker.setLatLng([-34.7493, -68.0575]);
                    }
        ...
        var ejemplo = [
            {
                nombre: 'Centro',
                envio: 1500,
                center: { lat: -34.7493, lng: -68.0575 },
                radiusM: 1800
            }
        ];
        try {
